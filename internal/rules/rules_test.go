...
func TestEmbeddedCatalogResolvesOfficialRulesAndPatterns(t *testing.T) {
	...
	want := []string{"architecture/astro-content-site@1", "architecture/dotnet-layered@1", "architecture/dotnet-multiproject@1", "architecture/nestjs-prisma-modular@1", "architecture/next-feature-app-router@1", "architecture/next-modular@1", "architecture/python-fastapi-modular@1", "architecture/react-tailwind-modular@1", "architecture/react-vite-modular@1"}
